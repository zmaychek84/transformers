...
static xrt::bo c_bo_;
/* XRT BO for tiled activation matrix */
static xrt::bo a_bo_token_;
/* XRT BO for tiled output matrix */
static xrt::bo c_bo_token_;
const std::vector<matrix_shapes> mladf_shape_list = {
    // formal shapes
    // matrix_shapes(1, 11008, 4096, 32),
    matrix_shapes(1, 11008, 4096, 128),
    // matrix_shapes(1, 4096, 4096, 32),
    matrix_shapes(1, 4096, 4096, 128),
    // matrix_shapes(1, 4096, 11008, 32),
    matrix_shapes(1, 4096, 11008, 128),
    // matrix_shapes(1, 4096, 12288, 32),
    matrix_shapes(1, 4096, 12288, 128),
    // matrix_shapes(1, 4096, 22528, 32),
    // matrix_shapes(1, 4096, 22528, 128),
    matrix_shapes(1, 4096, 32768, 32),
    matrix_shapes(1, 4096, 32768, 128),

    // matrix_shapes(128, 11008, 4096, 32),
    matrix_shapes(128, 11008, 4096, 128),
    // matrix_shapes(128, 4096, 4096, 32),
    matrix_shapes(128, 4096, 4096, 128),
    // matrix_shapes(128, 4096, 11008, 32),
    matrix_shapes(128, 4096, 11008, 128),
    // matrix_shapes(128, 4096, 12288, 32),
    matrix_shapes(128, 4096, 12288, 128),
    // matrix_shapes(128, 4096, 22528, 32),
    // matrix_shapes(128, 4096, 22528, 128),
    matrix_shapes(128, 4096, 32768, 32),
    matrix_shapes(128, 4096, 32768, 128),

    // matrix_shapes(256, 11008, 4096, 32),
    matrix_shapes(256, 11008, 4096, 128),
    // matrix_shapes(256, 4096, 4096, 32),
    matrix_shapes(256, 4096, 4096, 128),
    // matrix_shapes(256, 4096, 11008, 32),
    matrix_shapes(256, 4096, 11008, 128),
    // matrix_shapes(256, 4096, 12288, 32),
    matrix_shapes(256, 4096, 12288, 128),
    // matrix_shapes(256, 4096, 22528, 32),
    // matrix_shapes(256, 4096, 22528, 128),
    matrix_shapes(256, 4096, 32768, 32),
    matrix_shapes(256, 4096, 32768, 128),

    // matrix_shapes(512, 11008, 4096, 32),
    matrix_shapes(512, 11008, 4096, 128),
    // matrix_shapes(512, 4096, 4096, 32),
    matrix_shapes(512, 4096, 4096, 128),
    // matrix_shapes(512, 4096, 11008, 32),
    matrix_shapes(512, 4096, 11008, 128),
    // matrix_shapes(512, 4096, 12288, 32),
    matrix_shapes(512, 4096, 12288, 128),
    // matrix_shapes(512, 4096, 22528, 32),
    // matrix_shapes(512, 4096, 22528, 128),
    matrix_shapes(512, 4096, 32768, 32),
    matrix_shapes(512, 4096, 32768, 128),

    // matrix_shapes(800, 11008, 4096, 32),
    matrix_shapes(800, 11008, 4096, 128),
    // matrix_shapes(800, 4096, 4096, 32),
    matrix_shapes(800, 4096, 4096, 128),
    // matrix_shapes(800, 4096, 11008, 32),
    matrix_shapes(800, 4096, 11008, 128),
    // matrix_shapes(800, 4096, 12288, 32),
    matrix_shapes(800, 4096, 12288, 128),
    // matrix_shapes(800, 4096, 22528, 32),
    // matrix_shapes(800, 4096, 22528, 128),
    matrix_shapes(800, 4096, 32768, 32),
    matrix_shapes(800, 4096, 32768, 128),

    // matrix_shapes(1024, 11008, 4096, 32),
    matrix_shapes(1024, 11008, 4096, 128),
    // matrix_shapes(1024, 4096, 4096, 32),
    matrix_shapes(1024, 4096, 4096, 128),
    // matrix_shapes(1024, 4096, 11008, 32),
    matrix_shapes(1024, 4096, 11008, 128),
    // matrix_shapes(1024, 4096, 12288, 32),
    matrix_shapes(1024, 4096, 12288, 128),
    // matrix_shapes(1024, 4096, 22528, 32),
    // matrix_shapes(1024, 4096, 22528, 128),
    matrix_shapes(1024, 4096, 32768, 32),
    matrix_shapes(1024, 4096, 32768, 128),

    // matrix_shapes(2048, 11008, 4096, 32),
    matrix_shapes(2048, 11008, 4096, 128),
    // matrix_shapes(2048, 4096, 4096, 32),
    matrix_shapes(2048, 4096, 4096, 128),
    // matrix_shapes(2048, 4096, 11008, 32),
    matrix_shapes(2048, 4096, 11008, 128),
    // matrix_shapes(2048, 4096, 12288, 32),
    matrix_shapes(2048, 4096, 12288, 128),
    // matrix_shapes(2048, 4096, 22528, 32),
    matrix_shapes(2048, 4096, 22528, 128),
    matrix_shapes(2048, 4096, 32768, 32),
    matrix_shapes(2048, 4096, 32768, 128),
};
;
/*
...
const std::map<std::string, std::vector<matrix_shapes>>
    qlinear_2<InT, WtT, AccT, OutT>::default_shapes_ = {
        ...
        {"mladf_2x4x4_v1_a16fw4acc16f", mladf_shape_list},
        {"mladf_2x4x4_v0_a16fw4acc16f", mladf_shape_list},
        {
            "a8w8acc32",
            {
...
template <typename InT, typename WtT, typename AccT, typename OutT>
bool qlinear_2<InT, WtT, AccT, OutT>::initialize_bo_;
...
qlinear_2<InT, WtT, AccT, OutT>::qlinear_2(const std::string &a_dtype,
  ...
  std::string mladf_v_str = Utils::get_env_var("MLADF_VERSION", "v1");
  if ((mladf_v_str == "v0" || mladf_v_str == "v1") && is_mladf_enabled_) {
    mladf_version_ = mladf_v_str;
  }
  ...
  if (is_mladf_enabled_) {
    if (is_mladf_enabled_ == M4x4) {
      XCLBIN_FNAME = Utils::get_env_var("PYTORCH_AIE_PATH") + "\\xclbin\\" +
                     Utils::get_env_var("DEVICE") + "\\mladf_gemm_4x4_" +
                     xclbin_a_header.at(a_dtype_) +
                     xclbin_b_header.at(b_dtype_) +
    ...
    if (is_mladf_enabled_ == M4x4) {
      txn_fname_prefix_ =
          std::string("mladf_") + "4x4_" + txnbin_a_header.at(a_dtype_) +
          txnbin_b_header.at(b_dtype_) + txnbin_acc_header.at(c_dtype_);
    } else {
      txn_fname_prefix_ = std::string("mladf_") + "2x4x4_" + mladf_version_ +
                          "_" + txnbin_a_header.at(a_dtype_) +
...
void qlinear_2<InT, WtT, AccT, OutT>::initialize_weights_int4(
  ...
  if (!initialize_bo_) {
    ...
    const int A_BO_SIZE = (max_M * max_K * a_dtype_size_) + params_bytes;
    const int C_BO_SIZE = (max_M * max_N * sizeof(AccT));
    ...
    const int A_BO_SIZE_TOKEN = (1 * max_K * a_dtype_size_) + params_bytes;
    const int C_BO_SIZE_TOKEN = 1 * max_N * sizeof(AccT);
    a_bo_token_ =
...
void qlinear_2<InT, WtT, AccT, OutT>::initialize_weights_int4_mladf(
  ...
  if (!initialize_bo_) {
    ...
    int max_N = 32768;
    /* Create input/output BOs */
    const int A_BO_SIZE = max_M * max_K * a_dtype_size_;
    ...
    const int C_BO_SIZE = max_M * max_N * sizeof(OutT) * 2;
    // (kernel_x_shape_[1] != 11008)
    ...
    const int A_BO_SIZE_TOKEN = (1 * max_K * a_dtype_size_);
    const int C_BO_SIZE_TOKEN =
        max_N * sizeof(OutT) * 2; //(kernel_x_shape_[1] != 11008)
  ...
  w_padded_shape_[0] = Utils::ceil_for_me(w_shape_[0], kernel_y_shape_[0]);
  w_padded_shape_[1] = Utils::ceil_for_me(w_shape_[1], kernel_y_shape_[1]);
  // The bfp16 kernel uses a block size of 2 for any gemm shape.
  int blk_size = (mladf_version_ == "v1") ? 2 : 4;
...
void qlinear_2<InT, WtT, AccT, OutT>::set_kernel_shapes_m_mladf(
  ...
  if (a_dtype_ == "int8") {
    ...
    if (input_m == 1)
      ...
      kernel_x_rows = 128;
    else if (is_mladf_enabled_ == M4x4)
      kernel_x_rows = 2048; // for 4x4, not all intermediate M supported
    else if (input_m <= 256)
      kernel_x_rows = 256;
    else if (input_m <= 512)
      kernel_x_rows = 512;
    else if (input_m <= 1024)
      kernel_x_rows = 1024;
    else
      kernel_x_rows = 2048;
  } else
...
void qlinear_2<InT, WtT, AccT, OutT>::run_aie(InT *a, xrt::bo &w_bo,
  ...
  std::string instr_bo_key = txn_fname_prefix_ + "_" +
