...
interface DML_DECLARE_INTERFACE("6dbd6437-96fd-423f-a98c-ae5e7c2a573f")
  ...
  (IDMLOperator * op, DML_EXECUTION_FLAGS flags,
  ...
  IFACEMETHOD(Evict)
  (UINT count, _In_reads_(count) IDMLPageable *const *ppObjects) = 0;
...
interface DML_DECLARE_INTERFACE("427c1113-435c-469c-8676-4d5dd072f813")
  ...
  IFACEMETHOD(Reset)
  (UINT operatorCount,
   _In_reads_opt_(operatorCount) IDMLCompiledOperator *const *operators) = 0;
};
...
interface DML_DECLARE_INTERFACE("29c687dc-de74-4e3b-ab00-1168f2fc3cfc")
  ...
  (UINT bindingCount,
   _In_reads_opt_(bindingCount) const DML_BINDING_DESC *bindings) = 0;
...
interface DML_DECLARE_INTERFACE("e6857a76-2e3e-4fdd-bff4-5d2ba10fb453")
  ...
  (ID3D12CommandList * commandList, IDMLDispatchable * dispatchable,
...
interface DML_DECLARE_INTERFACE("a0884f9a-d2be-4355-aa5d-5901281ad1d2")
  ...
  (const DML_GRAPH_DESC *desc, DML_EXECUTION_FLAGS flags,
   REFIID riid, // expected: IDMLCompiledOperator
   _COM_Outptr_opt_ void **ppv) = 0;
};
