...
#if __has_include(<ryzenai/dyanmic_dispatch/xrt_context/xrt_context.hpp>)
#include <ryzenai/dyanmic_dispatch/xrt_context/xrt_context.hpp>
#else
...
public:
  ...
  void setup_hw_ctx(std::shared_ptr<dd::xrt_context> ctx) { xrt_ctx_ = ctx; }
